...
let page5 = document.getElementById("Map")
...
button5.addEventListener('click', () => {
    ...
    page5.className = "h-screen flex-grow flex flex-col"
    image5.src = "./assets/globeselected.svg"
    bar5.className = "absolute w-1.5 h-full bg-highlightblue top-0 right-0"
    button5.className = "w-full bg-bgblue relative cursor-pointer"
})
